    ...
    <section id="home" className="relative bg-white pt-12 pb-24 lg:pt-20 lg:pb-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        <div className="mt-8 flex flex-col items-center justify-center">
          <div className="text-3xl sm:text-4xl font-logo italic text-[#c68d37] font-medium tracking-wide">
            Sai Shares
          </div>
          <div className="relative mt-1">
            <span className="text-3xl sm:text-4xl font-logo italic text-[#e05a2b] font-medium tracking-wide flex items-center gap-2">
              WeGrowTogether
